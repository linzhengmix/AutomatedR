setwd("/Users/zhenglin/code/R_code/Automated_Data_Collection_with_R")
...
# worldheritagedanger.htm
# List_of_WorldHeritage_in_Danger_Wikipedia.html
# make sure that the file you use in the same workdirectory of the script
heritage_parsed <- htmlParse("List_of_WorldHeritage_in_Danger_Wikipedia.html",encoding="UTF-8")
